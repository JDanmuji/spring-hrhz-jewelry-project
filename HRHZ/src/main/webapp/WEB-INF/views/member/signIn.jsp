            ...
            <div class="outerWrapper">
                <form class="container" action="/signin" method="post">
                    <div class="signInForm">
                        ...
                        <!-- 로그인 유지하기 -->
                        <label class="checkboxContainer"> <input type="checkbox" /> <span class="checkmark"></span> 로그인 유지하기 </label>
                        ...
                        <div class="socialIcon">
                            <span class="socialIconKakao"><a href="#"></a></span> <span class="socialIconNaver"><a href="#"></a></span> <span class="socialIconFacebook"><a href="#"></a></span>
