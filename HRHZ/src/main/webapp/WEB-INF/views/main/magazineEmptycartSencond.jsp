            ...
            <section class="magazineTotalPage">
                <div class="magazineOuterWrapper">
                        ...
                        <div class="magazineSection">
                            <img class="magazineImg" src="../../images/main/empty_second.jpeg">
                            <img class="magazineImg" src="../../images/main/empty_second1.jpeg">
                            <img class="magazineImg" src="../../images/main/empty_second2.jpeg">                                                        
                        </div>
