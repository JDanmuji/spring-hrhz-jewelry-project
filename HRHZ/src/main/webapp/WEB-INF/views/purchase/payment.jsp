                                    ...
                                    <div class="payOrderInfo">
                                        ...
                                        <div class="deliveryInfo">
                                            ...
                                            <div class="registerAddress">
                                                <div
                                                    class="registerAddressCheck"
                                                >
                                                    <input
                                                        id="registerAddress"
                                                        type="checkbox"
                                                        name="baseDeliveryAddressCheck"
                                                        checked
                                                    />
                                                    <label
                                                        for="registerAddress"
                                            ...
                                            <div class="messageDropDown">
                                                <div class="dropDownCover">
                                                    <div
                                                        class="dropDownCoverSelector"
                                                    >
                                                        <div
                                                            class="dropDownSelect"
                                                        >
                                                            <span
                                                                class="dropDownSelectLabel"
                                                            >
                                                                택배 기사님
                                                                요청사항 선택
                                                            </span>
                                                    ...
                                                    <div
                                                        class="dropDownOverBox"
                                                    >
                                                        <div
                                                            class="dropDownList"
                                                        >
                                                            <div
                                                                class="dropDownSelectTitle"
                                                            >
                                                                <span
                                                                    class="dropDownSelectLabel"
                                                                >
                                            ...
                                            <section class="payMethodGrid">
                                                <div class="buttonBox">
                                                    <label for="payCard">
                                                        ...
                                                        >
                                                            <img
                                                                src="../images/purchase/pay_method_credit.png"
                                                            />
                                                        </div>
                                                        <div
                                                            class="payMethodDesciption"
                                                        >
                                                            <span
                                                                >신용/체크카드</span
                                                            >
                                                ...
                                                <div class="buttonBox">
                                                    <label for="payTossPay">
                                                        ...
                                                        >
                                                            <img
                                                                src="../images/purchase/pay_method_toss.png"
                                                            />
                                                        </div>
                                                        <div
                                                            class="payMethodDesciption"
                                                ...
                                                <div class="buttonBox">
                                                    <label for="payKakaoPay">
                                                        ...
                                                        >
                                                            <img
                                                                src="../images/purchase/pay_method_kakao.png"
                                                            />
                                                        </div>
                                                        <div
                                                            class="payMethodDesciption"
                                                ...
                                                <div class="buttonBox">
                                                    <label for="payNaverPay">
                                                        ...
                                                        >
                                                            <img
                                                                src="../images/purchase/pay_method_naver.png"
                                                            />
                                                        </div>
                                                        <div
                                                            class="payMethodDesciption"
                                                ...
                                                <div class="buttonBox">
                                                    <label for="payPayco">
                                                        ...
                                                        >
                                                            <img
                                                                src="../images/purchase/pay_method_payco.png"
                                                            />
                                                        </div>
                                                        <div
                                                            class="payMethodDesciption"
                                                ...
                                                <div class="buttonBox">
                                                    <label for="payVbank">
                                                        ...
                                                        >
                                                            <img
                                                                src="../images/purchase/pay_method_vbank.png"
                                                            />
                                                        </div>
                                                        <div
                                                            class="payMethodDesciption"
                                                ...
                                                <div class="buttonBox">
                                                    <label for="payTrans">
                                                        ...
                                                        >
                                                            <img
                                                                src="../images/purchase/pay_method_trans.png"
                                                            />
                                                        </div>
                                                        <div
                                                            class="payMethodDesciption"
